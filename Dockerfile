...
RUN cd /usr/local && curl -O https://sourceforge.net/projects/jboss/files/JBoss/JBoss-6.0.0.Final/jboss-as-distribution-6.0.0.Final.zip/download 
RUN cd /usr/local && unzip -q jboss-as-distribution-6.0.0.Final.zip
